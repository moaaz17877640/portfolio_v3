        ...
        <div className="lg:col-span-5 space-y-6">
          <SpotlightCard className="p-6 sm:p-8 border-white/10">
            <div className="flex items-center gap-3.5 pb-6 border-b border-white/[0.08]">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-tr from-cyan-500 to-indigo-600 p-[1px]">
                <div className="w-full h-full rounded-[11px] bg-dark-950 flex items-center justify-center text-cyan-300">
                  <Server className="w-6 h-6" />
                </div>
              </div>
              <div>
                <h3 className="font-bold text-white text-lg">{profile.name}</h3>
                <p className="text-xs font-mono text-cyan-400">{profile.headline}</p>
            ...
            <div className="mt-6 space-y-4 text-sm leading-relaxed text-slate-300">
              <p>
                I am a <strong className="text-white font-semibold">Cloud / DevOps Engineer</strong> passionate about turning complex infrastructure into predictable, automated code.
              </p>
              <p>
                At <strong className="text-white font-semibold">Azzrk</strong>, I maintain staging and production AWS environments, engineer custom CI/CD bridges, and build tooling that simplifies deployments for engineering teams.
              </p>
              <p>
                In parallel at the <strong className="text-white font-semibold">National Telecommunication Institute (NTI)</strong>, I teach modern cloud architectures, guiding students through practical labs with compute, storage, databases, and containerization.
              </p>
            </div>

            {/* Quick Badges */}
            <div className="mt-6 pt-6 border-t border-white/[0.08] flex flex-wrap gap-2">
              <span className="px-2.5 py-1 rounded-md text-xs font-mono bg-white/[0.04] border border-white/10 text-slate-300">
        ...
        <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4 sm:gap-6">
          {engineeringPillars.map((pillar, idx) => {
            ...
            return (
              ...
              >
                <SpotlightCard className="p-6 h-full flex flex-col justify-between border-white/[0.08] hover:border-cyan-500/40">
                  <div>
                    <div className="flex items-center justify-between mb-4">
                      <div className="w-10 h-10 rounded-lg bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400">
                        <Icon className="w-5 h-5" />
                      </div>
                      <span className="text-[11px] font-mono px-2 py-0.5 rounded bg-white/[0.04] border border-white/[0.08] text-slate-400">
                        {pillar.tag}
                      </span>
                    </div>
                  ...
                  <div className="mt-4 pt-3 border-t border-white/[0.04] flex items-center gap-1.5 text-xs text-cyan-400/80 font-mono">
